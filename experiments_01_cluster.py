...
TESTING = True
data_filename = 'experiments_01_cluster_data.pickle'
results_filename = r'experiments_01_cluster_results.csv'


from ipyparallel import Client
c = Client(profile='slurm')
print(f'Running {__filename__} on SLURM cluster of size {len(c.ids)}')
